...
/**
 * Day 2 principle 04 — "Signal is earned; Brass is the brand." The Day 2
 * sample-copy block put Signal green on the primary CTA, which is exactly
 * the decorative use the principle rules out. Corrected here: primary is
 * filled Brass (CHOSN's actual identifying color); Signal never appears
 * on a button — it's reserved for Badge and PriceFigure trend states.
 */
